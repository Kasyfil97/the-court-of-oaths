    ...
    const PAGES = [
      {
        ...
        lines: [
          ...
          { text: '  and RANDOMIZED every game.', color: '#aaaaaa' },
          { text: '  Each House may be a different', color: '#aaaaaa' },
          { text: '  archetype than last run.', color: '#aaaaaa' },
          { text: '  Deduce from their moves.', color: '#ffdd44' },
          { text: '', color: '#cccccc' },
