class TitleScene extends Phaser.Scene {
  ...
  _showAbout() {
    ...
    const PAGES = [
      ...
      {
        title: 'BOT ADAPTATION',
        color: '#ff6b6b',
        lines: [
          { text: 'Bots now LEARN from your', color: '#aaaaaa' },
          { text: 'playstyle and adapt in real-time!', color: '#aaaaaa' },
          { text: '', color: '#cccccc' },
          { text: 'The Saint: Betrays if you do', color: '#aaaaaa' },
          { text: '  it too much (>40%).', color: '#aaaaaa' },
          { text: '', color: '#cccccc' },
          { text: 'The Mirror: Tests with rare', color: '#aaaaaa' },
          { text: '  betrayals if you are too', color: '#aaaaaa' },
          { text: '  predictably cooperative.', color: '#aaaaaa' },
          { text: '', color: '#cccccc' },
          { text: 'The Flatterer: Betrayal point', color: '#aaaaaa' },
          { text: '  varies (2-4 turns) each game.', color: '#aaaaaa' },
        ],
      },
      {
        title: 'ECONOMIC SCARCITY',
        color: '#4ecdc4',
        lines: [
          { text: 'Gold is now SCARCE!', color: '#ffdd44' },
          { text: '', color: '#cccccc' },
          { text: 'Starting Gold: 20 (was 30)', color: '#aaaaaa' },
          { text: '', color: '#cccccc' },
          { text: 'INFLATION MECHANIC:', color: '#ffdd44' },
          { text: '  More gold in circulation =', color: '#aaaaaa' },
          { text: '  Less value per gold coin!', color: '#aaaaaa' },
          { text: '', color: '#cccccc' },
          { text: 'At 120+ gold: Coins worth 30%', color: '#aaaaaa' },
          { text: '  less. Hoarding is punished!', color: '#aaaaaa' },
        ],
      },
      {
        ...
        color: '#4488ff',
        lines: [
          { text: 'ECONOMY (Gold \u2265 150)', color: '#ffdd44' },
